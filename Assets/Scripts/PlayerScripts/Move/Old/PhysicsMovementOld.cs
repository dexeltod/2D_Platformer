...
public abstract class PhysicsMovementOld : MonoBehaviour
{
	...
	private void Move(Vector2 move, bool yMovement)
	{
		...
		if (distance > MinMoveDistance)
		{
			...
			{
				SetCountedDistance(ref distance, yMovement, i);
			}
		}
	...
	private void SetCountedDistance(ref float distance, bool yMovement, int hitIndex)
	{
